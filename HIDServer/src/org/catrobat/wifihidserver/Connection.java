...
public class Connection extends Thread {
	...
	public Connection(Socket client, InputHandler inhan, StartUI ui,
			int connectionNumber, ConnectionHandler connect, Server server,
			ObjectInputStream objectInput, ObjectOutputStream objectOutput) {
		this.client = client;
		inputHandler = inhan;
	...
	public void getInput() {
		...
		try {
			...
			System.out.println("Connection to " + remoteIp
					+ " broke. Inputstream is closed.");
			stopThread();
			return;
